...
namespace Nebulas.Signer.Crypto
{
    /// <summary>
    ...
    public class ECKey
    {
        ...
        public byte[] GetPubKey(bool isCompressed)
        {
            ...
            //Pub key (q) is composed into X and Y, the compressed form only include X, which can derive Y along with 02 or 03 prepent depending on whNaser Y in even or odd.
            q = q.Normalize();
            var result =
